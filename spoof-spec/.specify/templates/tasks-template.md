...
**Tests**: Primary user flows MUST have automated tests. Include tests for all
primary functionality defined in the spec.
...
- [ ] T004 [P] Add GitHub Actions workflow to run full test suite on PRs
...
### Tests for User Story 1 (REQUIRED for primary functionality) ⚠️
...
### Tests for User Story 2 (REQUIRED for primary functionality) ⚠️
...
### Tests for User Story 3 (REQUIRED for primary functionality) ⚠️
